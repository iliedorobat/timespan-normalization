...
```bash
  ...
  java -jar build/libs/temporal-normalization-1.7-patch1.jar --historicalOnly=true --expression="1/2 sec. 3 a. chr - sec. 2 p. chr."
  # Include future dates
  java -jar build/libs/temporal-normalization-1.7-patch1.jar --expression="1/2 sec. 3 a. chr - sec. 2 p. chr."
```

### Normalize multiple temporal expressions:
```bash
  # Parse only historical dates
  java -jar build/libs/temporal-normalization-1.7-patch1.jar --historicalOnly=true --analysis
  # Include future dates
  java -jar build/libs/temporal-normalization-1.7-patch1.jar --analysis
```
